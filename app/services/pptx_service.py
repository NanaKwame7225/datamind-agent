...
# ── AUTHOR SIGNATURE — appears on every generated deck ────────────────────────
SIGNATURE = {
...
class PowerPointExportService:
    ...
    def build_deck(self, result: dict, finance: dict = None, chart_images: list = None) -> bytes:
        ...
        self._text(s, f"Prepared by {SIGNATURE['name']}", Inches(0.9), Inches(6.1),
                   Inches(11.5), Inches(0.45), 13, LIGHT)
        self._text(s, f"{date_str}  •  {SIGNATURE['org']}  •  {SIGNATURE['location']}", Inches(0.9), Inches(6.55),
        ...
        s = prs.slides.add_slide(blank)
        self._fill_bg(s, prs, DARK)
        self._text(s, "Thank You", Inches(0.9), Inches(1.6), Inches(11.5), Inches(1),
                   40, ACCENT, bold=True, align=PP_ALIGN.CENTER)

        # Divider
        from pptx.dml.color import RGBColor as _RGB
        div = s.shapes.add_shape(1, Inches(5.2), Inches(2.9), Inches(2.9), Inches(0.03))
        div.fill.solid(); div.fill.fore_color.rgb = _RGB(*ACCENT); div.line.fill.background()

        self._text(s, "Prepared by", Inches(0.9), Inches(3.2), Inches(11.5), Inches(0.4),
                   12, GREY, align=PP_ALIGN.CENTER)
        self._text(s, SIGNATURE["name"], Inches(0.9), Inches(3.65), Inches(11.5), Inches(0.6),
                   22, LIGHT, bold=True, align=PP_ALIGN.CENTER)
        self._text(s, f"Telephone: {SIGNATURE['phone1']}  •  {SIGNATURE['phone2']}",
                   Inches(0.9), Inches(4.35), Inches(11.5), Inches(0.45), 13,
                   (0x8a, 0xa0, 0xc0), align=PP_ALIGN.CENTER)
        self._text(s, SIGNATURE["linkedin"], Inches(0.9), Inches(4.85), Inches(11.5), Inches(0.45),
                   12, ACCENT, align=PP_ALIGN.CENTER)
        self._text(s, f"Generated by DataMind Agent — AI Data Analysis Platform",
                   Inches(0.9), Inches(6.1), Inches(11.5), Inches(0.45), 11, GREY, italic=True, align=PP_ALIGN.CENTER)
        self._text(s, f"{SIGNATURE['org']}  •  {SIGNATURE['location']}", Inches(0.9), Inches(6.5),
                   Inches(11.5), Inches(0.45), 11, GREY, align=PP_ALIGN.CENTER)
